...
def docs_build(session: Session, django: str) -> None:
    ...
    session.install(".")
    session.install("sphinx", "sphinx-click", "furo", "myst-parser", "sphinxcontrib.mermaid")
...
def docs(session: Session, django: str) -> None:
    ...
    session.install(".")
    session.install("sphinx", "sphinx-autobuild", "sphinx-click", "furo", "myst-parser", "sphinxcontrib.mermaid")
